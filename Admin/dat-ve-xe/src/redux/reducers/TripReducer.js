import {
	GET_DETAIL_TRIP,
	GET_DETAIL_TRIPPASSENGER,
	GET_TRIP,
	GET_TRIP_PASSENGER,
	SET_TRIPPASSENGER_CREATE,
	SET_TRIP_CREATE,
	RESET_TRIP_CREATED,
	RESET_TRIPPASSENGER_CREATED, // ✅ import thêm action reset
...
export default (state = initialState, action) => {
	switch (action.type) {
		...
		// ✅ Thêm case RESET
		case RESET_TRIP_CREATED: {
			return {...state, tripCreated: {}};
		}
		case RESET_TRIPPASSENGER_CREATED: {
			return {...state, tripPassengerCreated: {}};
		}
		default:
			return state;
	}
