...
export default function AdminVehicle() {
	...
	// Thêm đoạn in ra console ở đây
	console.log("PassengerCar type and price:");
	listVehicle.forEach((vehicle) => {
		console.log(`Vehicle: ${vehicle.name}, PassengerCar type: ${vehicle.type}, price: ${vehicle.passengerCar?.price}`);
	});
	useEffect(() => {
