...
const { register, login, uploadAvatar, getAllTrip, getAllUser, getDetailUser, updateUser, deleteUser, updateUserBooking, getUserInfo,checkEmailUser,sendOtpEmail ,changePass } = require("../controllers/user.controllers");
